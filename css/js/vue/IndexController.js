    ...
    methods: {
        ...
        async PostData() {
            Swal.fire({
                ...
                text: `กำลังประมวลผล`,
                imageUrl: './asset/images/reload.gif',
        ...
        async GetPateintByCid(cid) {
            ...
            await fetch(`http://localhost:8000/coreapi/api/v1/get_patient/${cid}`, requestOptions).then(responses => responses.json()).then(results => {
        ...
        async SavePhone() {
            ...
            fetch("http://localhost:8000/coreapi/api/v1/post_authen", requestOptions).then(response => response.json()).then(result => {
                swal.close({});
